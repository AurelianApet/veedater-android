...
/**
 * Created by dmlabs on 5/1/18.
 */

public class WithoutSubscription extends Fragment implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener,PermissionUtil.PermissionResultCallback  {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        imageAdapter  =new ImageAdapter(getChildFragmentManager(),arrayList,getActivity(),false);
        ...
        imageAdapter.setOnPageClick(new ImageAdapter.OnPageClick() {
            ...
            @Override
            public void makePayment(int pos) {
                openDialog();
            }
